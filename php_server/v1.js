...
//	    }],
   ...
   var data_size = {
   	...
   	function GetFileSize() {
		...
		$.ajax({
		      url: "api.php?action=get_size&file="+target_file,
	...
	function ClearLogs() {
		$.ajax({
		      url: "api.php?action=truncate&file="+target_file,
		      context: document.body,
		      success: function(result) {
		         ClearLoadedData();
	...
	function DownloadFile() {
		window.location="api.php?action=get&file="+target_file;
	}
	...
	function Loader() {
	   ...
	   $.ajax({
	      url: "api.php?action=get&file="+target_file+"&offset="+offset+"&length="+request_size,
	      context: document.body,
	      success: HandleData
	   }).done(function() {
	      //$( this ).addClass( "done" );
